...
$tanggal = date("Y-m-d H:i:s");
	  ...
	  $simpan = mysql_query("UPDATE user SET saldo=saldo-$harg WHERE username = '$username'");
          $simpan = mysql_query("INSERT INTO historyall VALUES('','$no','$nama','$pakt Like Facebook Code $layan','$harg','Proccess',' $idignya','$tanggal')");
...
<div class="alert alert-info">
   ====================================<br>
    Pesanan : <?php echo $pakt; ?> Like Facebook<br>
    Link Status/Photo : <?php echo $idignya; ?><br>
