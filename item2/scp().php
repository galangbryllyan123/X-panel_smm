...
$tanggal = date("Y-m-d H:i:s");
	  ...
	  $simpan = mysql_query("UPDATE user SET saldo=saldo-$harg WHERE username = '$username'");
          $simpan = mysql_query("INSERT INTO historyall VALUES('','$no','$nama','$pakt Sound Cloud Play Code $layan','$harg','Proccess',' $idignya','$tanggal')");
if($simpan) { 
...
<div class="alert alert-info">
   ====================================<br>
    Pesanan : <?php echo $pakt; ?> Sound Cloud Play<br>
    Link SoundCloud : <?php echo $idignya; ?><br>
    Kode : <?php echo $layan; ?><br>
    Price : <?php echo $pakt; ?> Play = <?php echo $harg; ?>Saldo<br>
    ====================================<br>
<?php
    $apikey = "";
    $command = "add";
