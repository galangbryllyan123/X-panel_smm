...
$tanggal = date("Y-m-d H:i:s");
	  ...
	  $simpan = mysql_query("UPDATE user SET saldo=saldo-$harg WHERE username = '$username'");
          $simpan = mysql_query("INSERT INTO historyall VALUES('','$no','$nama','$pakt Follower Instagram Code $layan','$harg','Proccess','  $idignya','$tanggal')");
...
<div class="alert alert-info">
   ====================================<br>
    Pesanan : <?php echo $pakt; ?> Follower Instagram<br>
    Username Instagram : <?php echo $idignya; ?><br>
    Kode : <?php echo $layan; ?><br>
    Price : <?php echo $pakt; ?> Follower = <?php echo $harg; ?>Saldo<br>
    ====================================<br>
<?php
