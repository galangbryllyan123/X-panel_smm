...
<h2>Like Status/Photo Facebook</h2>
</header>
<div class="main-box-body clearfix">		
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Link Status/Photo</label>
                                            <div class="col-md-9">
											<div class="input-group">

<input class="form-control" name="usrnmlink" id="usrnmlink" placeholder="Link" type="text">
</div>
                                        </div>          
                                   </div>  
<br />         
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control select" id="layanan" name="layanan">
                                                <option value="80">  Like Status/Photo Facebook  ( MAX 5K )</option>
...
<br>
- Pastikan Status/Photo Dalam Keadaan Publik<br />
<br>
- Tidak Dapat Di gunakan Untuk Bukti Konsumen atau Like Status pada Status Sebuah Fanspage<br />
<br>
