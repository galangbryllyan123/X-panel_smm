...
<input class="form-control" name="usrnmlink" id="usrnmlink" placeholder="Masukan Link Video" type="text">
</div>
                                        </div>          
                                   </div>  
<br />         
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control select" id="layanan" name="layanan">
                                                <option value="77">  Youtube Worldwide Views Server 1  </option>
                                                <option value="78">  Youtube Worldwide Views Server 2 </option>
                                          </select>
                                        </div>
                                    </div>
<br />         
...
<br>
- Pastikan Link Benar dan Video Tidak dalam Keadaan Private <br />
<br>
