...
$tanggal = date("Y-m-d H:i:s");
	  ...
	  $simpan = mysql_query("UPDATE user SET saldo=saldo-$harg WHERE username = '$username'");
          $simpan = mysql_query("INSERT INTO historyall VALUES('','$no','$nama','$pakt Follower Twitter Code $layan','$harg','Proccess',' $idignya','$tanggal')");
...
<div class="alert alert-info">
   ====================================<br>
    Pesanan : <?php echo $pakt; ?> Follower Twitter<br>
    Username Twitter : <?php echo $idignya; ?><br>
