...
<div class="main-box-body clearfix">		
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Link Fanspage</label>
                                            <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control select" id="layanan" name="layanan">
                                                <option value="4">  Like FansPage Facebook  ( MAX 1K )</option>
                                          </select>
                                        </div>
                                    </div>
<br />         
...
<br>
- Pastikan Fanspage Sudah Dalam Keadaan Publish <br />
<br>
