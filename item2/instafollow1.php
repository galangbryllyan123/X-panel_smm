                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control select" id="layanan" name="layanan">
                                                ...
                                                <option value="145">  Instagram Followers Server 1  ( MAX 2K )</option>
                                                <option value="106">  Instagram Followers Server 2  ( MAX 3K )</option>
                                                <option value="102">  Instagram Followers Server 3  ( MAX 5K )</option>
                                          </select>
                                        </div>
                                    </div>
<br />         
...
var namaaplikasi = $("#layanan").val();
 if(namaaplikasi== "145"){
  ...
  $('#harga').val(hasil);
} else if (namaaplikasi== "106"){
  var hasil = eval(jumlah) * 28;
  $('#harga').val(hasil);
} else if (namaaplikasi== "102"){
  var hasil = eval(jumlah) * 27;
  $('#harga').val(hasil);
 } 
} 
