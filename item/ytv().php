...
$tanggal = date("Y-m-d H:i:s");
	  ...
	  $simpan = mysql_query("UPDATE user SET saldo=saldo-$harg WHERE username = '$username'");
          $simpan = mysql_query("INSERT INTO historyall VALUES('','$no','$username','$pakt Viewers Video YouTube Server $layan','$harg','Sukses','Url/Username : $idignya','$tanggal')");
if($simpan) { 
...
<? } else if ($order->result == "success") { ?>
    ====================================<br>
    Pesanan : <?php echo $pakt; ?> Viewers YouTube Beres!<br>
    Link/URL Video Youtube : <?php echo $idignya; ?><br>
    Server : <?php echo $layan; ?><br>
    Price : <?php echo $pakt; ?> Viewers = <?php echo $harg; ?><br><br>
