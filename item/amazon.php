...
?>
				<div class="panel-heading">
					<span class="panel-title">Akun Amazon</span>
				</div>
...
$q1 = mysql_query("SELECT * FROM amazon WHERE jenis = 'Amazon'");
...
<i><pre>
NB* Harga Seperti Yang Sudah Di tetapkan Admin
</pre></i>
				</div>
