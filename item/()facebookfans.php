...
$tanggal = date("Y-m-d H:i:s");
	  ...
	  $simpan = mysql_query("UPDATE user SET saldo=saldo-$harg WHERE username = '$username'");
          $simpan = mysql_query("INSERT INTO historyall VALUES('','$no','$idignya','$pakt FansPage Likes Server $layan','$harg','Sukses','Url/Username : $idignya','$tanggal')");
if($simpan) { 
...
<? } else if ($order->result == "success") { ?>
    ====================================<br>
    Pesanan : <?php echo $pakt; ?> FansPage Like Beres!<br>
