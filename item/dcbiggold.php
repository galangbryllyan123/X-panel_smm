...
<br>
	<span><select value="<?PHP echo $_POST['mode']; ?>" id="jumlah" name="mode"> 
					
			<option VALUE="1000000">80M </option>
...
<i><pre>
Kalau Sudah Submit Tunggu Beberapa detik lalu check Dragon City Anda :D Gold Akan Bertambah
</pre></i>
                                </div>
