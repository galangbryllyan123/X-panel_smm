...
$tanggal = date("Y-m-d H:i:s");
	  ...
	  $simpan = mysql_query("UPDATE user SET saldo=saldo-$harg WHERE username = '$username'");
          $simpan = mysql_query("INSERT INTO historyall VALUES('','$no','$username','$pakt Plays Music SoundCloud Server $layan','$harg','Sukses','Url/Username : $idignya','$tanggal')");
if($simpan) { 
...
<? } else if ($order->result == "success") { ?>
    ====================================<br>
    Pesanan : <?php echo $pakt; ?> Plays Music SoundCloud Beres!<br>
    URL Music SoundCloud : <?php echo $idignya; ?><br>
    Server : <?php echo $layan; ?><br>
    Price : <?php echo $pakt; ?> Plays Music = <?php echo $harg; ?><br><br>
