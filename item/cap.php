...
?>
				<div class="panel-heading">
					<span class="panel-title">Cap Orderan</span>
				</div>
...
<option value="1">Cap Biasa</option>
<option value="1">Cap IGGY</option>
<option value="1">Cap C4D</option>
<option value="1">Cap NEW</option>
                                                </select>
                                            </div>
                                        </div>
<br />         
...
<i><pre>
*Setiap Pembelian Cap Orderan Akan Di Potong Saldo .... Menghindari Permainan Harga <br>
ALL Cap Orderan : 
Harganya : 5.000 <br>
</div>
<br>
